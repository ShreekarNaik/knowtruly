...
export const demoProfile: Profile = {
  ...
  summary:
    "Engineer focused on trustworthy talent intelligence. I build matching engines, resume automation, and signature pipelines that help candidates tell their stories with evidence.",
  contactHandles: {
  ...
  positions: [
    {
      ...
      description:
        "Designed the semantic matchmaker service, Gemini-based resume generation flows, and signature verification pipeline.",
    ...
    },
    {
      ...
      endDate: "2023-02-28",
      description:
        "Built interviewer analytics dashboards and optimized resume scoring accuracy by 23% using hybrid embeddings.",
...
export const demoResumeDetails: Record<string, ResumeDetail> = {
  "resume-1": {
    resumeId: "resume-1",
...
export const demoTemplates: TemplateDetail[] = [
  {
    templateId: "tmpl-modern",
    name: "Modern Tech",
...
export const demoClaims: VerifiableClaim[] = [
  {
    claimId: "claim-1",
...
export const demoAuditLog: AuditLogResponse = {
...
export const demoRecruiterCandidates: CandidatePreview[] = [
  {
    candidateId: "demo-profile",
    name: "Sophia Carter",
